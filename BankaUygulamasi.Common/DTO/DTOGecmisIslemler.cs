...
namespace BankaUygulamasi.Common.DTO
{
    public class DTOGecmisIslemler
    {
        ...
        public DTOGecmisIslemler(int islemNo, int gonderenMusteri, int gonderilenMusteri, int gonderenHesap, int gonderilenHesap, decimal miktar, string bilgi, DateTime tarih)
        {
